...
prop_data <- data.frame(
  ...
  Q5 = do.call(c, cd1 %>% select(starts_with("Q5_")))
)
...
# Plot the effects
b<- plot(effect, multiline = TRUE, main = "Usage vs Trust PT")
b
...
# Plot the effects
d<- plot(effect, multiline = TRUE, main = "Usage vs Trust FT")
d
```
...
predicted_probs <- predict(prop_model_with_group, type = "response")
